...
# Input files
* TE consensus sequences in fasta (fa/fa.gz) format (--TE argument). Follow these instrucionts to generate a proper TE consensus sequences input file (https://github.com/fansalon/TEspeX/blob/master/README_TE_input)
